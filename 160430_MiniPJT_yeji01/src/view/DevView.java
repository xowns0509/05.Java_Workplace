...
//		p_Left_North_Up.add(new JLabel("<html>Hello World!<br>blahblahblah</html>", SwingConstants.CENTER))
//		p_Left_North_Up.add(new JLabel("<html>안녕하세요 <br>blahblahblah</html>", SwingConstants.CENTER));
