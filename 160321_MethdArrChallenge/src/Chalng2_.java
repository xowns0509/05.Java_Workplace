/* 2. 정수형 데이터(int) 2개를 매개변수로 받아서 뺄셈 연산을 수행하여 결과값을 반환하는 subtract 메소드를 선언하고,
 * 입력 받은 두 수를 인자로 보내서 그 메소드를 호출하여 결과값을 출력하는 프로그램을 작성하시오.*/
import java.util.*;
public class Chalng2_ {
	...
	public static void main(String[] args) {
		...
		int result = subtract(inpt_int0, inpt_int1);
	...
	static int subtract(int inpt_int0, int inpt_int1){
