...
public class MakeCheckList extends JPanel implements ActionListener{
	...
	JPanel p_checkList, p_createList, p_input, p_cat, p_content, p_buttons;
	Box box;
	...
	void addLayout(){		
		...
		p_checkList = new JPanel(); //왼쪽 체크리스트 뜨는 부분
		...
		JScrollPane scroll = new JScrollPane(p_input); //TODO: 오토스크롤 추가하기 		
		...
		p_createList.add(scroll, BorderLayout.CENTER);


		//splitpane 에 붙이기
		splitPane = new JSplitPane( JSplitPane.HORIZONTAL_SPLIT,p_checkList, p_createList);
